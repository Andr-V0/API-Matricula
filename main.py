...
def startup_db_client():
    # Verificar y crear el tipo de usuario "EST"
    ...
    # Verificar y crear el tipo de usuario "PROF"
    ...
    # Verificar y crear el tipo de usuario "ADM"
...
def shutdown_db_client():
    # Si necesitas cerrar la conexión a la base de datos, puedes hacerlo aquí
    pass
